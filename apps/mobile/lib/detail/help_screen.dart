    ...
    body: ListView(
      ...
      children: customerService
          ...
          : [
              ...
              _lesson(
                '小米与红米动态壁纸权限',
                '若视频系统设置页立即返回，请在手机设置→应用管理→倾境壁纸→权限管理→其他权限中允许动态壁纸服务，再回到作品详情重新检测手机能力。Android 13 或更早系统可能无法读取设置位置；系统返回确认后保留已校验的视频，请到桌面和锁屏检查实际效果。',
              ),
              _lesson(
                '04 获得与设置',
              ...
              _lesson(
                '05 试用边界',
                '两分钟试用尚在接入；当前全屏预览仅使用已获得并安全安装的静态或视频资源，不以作品封面替代真实效果。试用就绪后也不会设置系统壁纸或授予权益。',
              ),
              _lesson(
                '06 提交素材与授权',
