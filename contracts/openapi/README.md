...
当前契约为 **1.7.0，58 操作 / 86 Schema**：4D 配置版本作为不低于 2 的客户端数据保存，算法字段原样透传；管理 DTO 不展开算法字段。源包制作说明见 [4D 源包制作说明](../../packages/wallpaper-format/4D源包制作说明.md)。1.6.0 快照逐字节归档于 `baseline-v1.6.0.json`。
