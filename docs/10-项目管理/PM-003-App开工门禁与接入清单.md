...
> 本文主体保留 WP-P12 的 1.0.1 开工历史审计。WP-A03 为 1.1.0 安装身份扩展，WP-A05 为 1.2.0 安全资源交付扩展；当前能力与状态以 PM-002、最新 OpenAPI/baseline-v1.json 和 WP-A05 验证记录为准。历史快照保留为 baseline-v1.0.1.json、baseline-v1.1.0.json。下文当时的“未实现”陈述不作为当前实现状态；Android 真机、端侧安装和系统设置仍需后续验收。
