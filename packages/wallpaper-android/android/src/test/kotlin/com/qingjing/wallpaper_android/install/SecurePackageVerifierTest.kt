        ...
        val payloads = when(type) {
            ...
            "VIDEO" -> listOf(Triple("VIDEO", "video/mp4", byteArrayOf(4,5,6)))
                ...
                Triple("PARALLAX_CONFIG", "application/json",
                    """{"formatVersion":2,"canvas":{"width":512,"height":512},"motion":{"maxAngle":$parallaxAngle},"layers":[{"index":1,"offsetPercent":55,"direction":"follow","scale":1.1,"opacity":1,"blendMode":"normal"},{"index":2,"offsetPercent":20,"direction":"reverse","scale":1,"opacity":1,"blendMode":"normal"}]}""".toByteArray()))
        }
