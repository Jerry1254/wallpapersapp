    ...
    private fun fixture(type: String = "STATIC_IMAGE", version: Int = 1, manifestEdit: (String) -> String = { it },
        ...
        val payloads = when(type) {
            ...
            "VIDEO" -> listOf(Triple("VIDEO", "video/mp4", byteArrayOf(4,5,6)))
                ...
                Triple("PARALLAX_CONFIG", "application/json", """{"canvas":{"width":512,"height":512},"sensor":{"maxAngle":10,"smoothing":0.2,"strength":1},"layers":[{"role":"BACKGROUND","ordinal":0,"depth":0,"scale":1.1,"opacity":1,"blendMode":"normal"},{"role":"FOREGROUND","ordinal":0,"depth":1,"scale":1.1,"opacity":1,"blendMode":"normal"}]}""".toByteArray()))
        }
